...
# bash <(curl -s https://raw.githubusercontent.com/EdificeEdtech/configuration/master/util/install/ansible-bootstrap.sh)
...
if [[ -z "${CONFIGURATION_REPO}" ]]; then
  CONFIGURATION_REPO="https://github.com/EdificeEdtech/configuration.git"
fi
